...
<text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-family="Verdana" font-size="25" opacity="0">Chet rolled a 3<animate id="b0_anim10" begin="b0_anim9.end" attributeName="opacity" from="0" to="1" dur="0.2s" repeatCount="1" fill="freeze"/>
<animate id="b0_anim11" begin="b0_anim10.end + 1s" attributeName="opacity" from="1" to="0" dur="0.2s" repeatCount="1" fill="freeze"/>
</text>
<animate id="b0_anim12" xlink:href="#b0_playerA" begin="b0_anim11.end" attributeName="cx" to="75" dur="0.5s" repeatCount="1" fill="freeze"/>
<animate  xlink:href="#b0_playerA" begin="b0_anim11.end" attributeName="cy" to="25" dur="0.5s" repeatCount="1" fill="freeze"/>
<animate id="b0_anim13" xlink:href="#b0_playerA" begin="b0_anim12.end" attributeName="cx" to="125" dur="0.5s" repeatCount="1" fill="freeze"/>
<animate  xlink:href="#b0_playerA" begin="b0_anim12.end" attributeName="cy" to="25" dur="0.5s" repeatCount="1" fill="freeze"/>
<animate id="b0_anim14" xlink:href="#b0_playerA" begin="b0_anim13.end" attributeName="cx" to="175" dur="0.5s" repeatCount="1" fill="freeze"/>
<animate  xlink:href="#b0_playerA" begin="b0_anim13.end" attributeName="cy" to="25" dur="0.5s" repeatCount="1" fill="freeze"/>
<text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-family="Verdana" font-size="25" opacity="0">Question Rock...<animate id="b0_anim15" begin="b0_anim14.end" attributeName="opacity" from="0" to="1" dur="0.2s" repeatCount="1" fill="freeze"/>
<animate id="b0_anim16" begin="b0_anim15.end + 1s" attributeName="opacity" from="1" to="0" dur="0.2s" repeatCount="1" fill="freeze"/>
</text>
<text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-family="Verdana" font-size="25" opacity="0">Chet correctly answered to Rock question<animate id="b0_anim17" begin="b0_anim16.end" attributeName="opacity" from="0" to="1" dur="0.2s" repeatCount="1" fill="freeze"/>
<animate id="b0_anim18" begin="b0_anim17.end + 1s" attributeName="opacity" from="1" to="0" dur="0.2s" repeatCount="1" fill="freeze"/>
</text>
<text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-family="Verdana" font-size="25" opacity="0">Chet wins the game !!!<animate id="b0_anim19" begin="b0_anim18.end" attributeName="opacity" from="0" to="1" dur="0.2s" repeatCount="1" fill="freeze"/>
<animate id="b0_anim20" begin="b0_anim19.end + 1s" attributeName="opacity" from="1" to="0" dur="0.2s" repeatCount="1" fill="freeze"/>
</text>
<text id="b0_text1" x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-family="Verdana" font-size="25" opacity="1"><set begin="b0_anim9.begin" attributeName="opacity" to="0" repeatCount="1" fill="freeze"/><set begin="b0_anim20.end + 1s" attributeName="opacity" to="1" repeatCount="1" fill="freeze"/>Click to start</text>
<rect x="0" y="0" width="800" height="200" opacity="0.1">
  <animate id="b0_anim9" begin="click" attributeName="x" from="0" to="0" dur="0.01s" repeatCount="1" fill="freeze"/>
  <set begin="b0_anim9.begin" attributeName="width" to="50" repeatCount="1" fill="freeze"/>
  <set begin="b0_anim9.begin" attributeName="height" to="50" repeatCount="1" fill="freeze"/>
  <animate id="b0_animEnd" begin="b0_anim20.end + 1s" attributeName="x" from="0" to="0" dur="0.01s" repeatCount="1" fill="freeze"/>
  <set begin="b0_anim20.end + 1s" attributeName="width" to="800" repeatCount="1" fill="freeze"/>
  <set begin="b0_anim20.end + 1s" attributeName="height" to="200" repeatCount="1" fill="freeze"/>
</rect>
<style>
text {
font-size: 30px;
