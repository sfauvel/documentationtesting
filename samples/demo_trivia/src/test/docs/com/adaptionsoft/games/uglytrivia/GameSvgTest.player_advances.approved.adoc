...
<animate attributeName="x" begin="b4_anim36.end" dur="0.5s" fill="freeze" id="b4_anim37" repeatCount="1" to="150" xlink:href="#b4_playerChet"/>
<animate attributeName="y" begin="b4_anim36.end" dur="0.5s" fill="freeze" repeatCount="1" to="100" xlink:href="#b4_playerChet"/>
<animate attributeName="x" begin="b4_anim37.end" dur="0.5s" fill="freeze" id="b4_anim38" repeatCount="1" to="150" xlink:href="#b4_playerChet"/>
<animate attributeName="y" begin="b4_anim37.end" dur="0.5s" fill="freeze" repeatCount="1" to="150" xlink:href="#b4_playerChet"/>
<animate attributeName="x" begin="b4_anim38.end" dur="0.5s" fill="freeze" id="b4_anim39" repeatCount="1" to="100" xlink:href="#b4_playerChet"/>
<animate attributeName="y" begin="b4_anim38.end" dur="0.5s" fill="freeze" repeatCount="1" to="150" xlink:href="#b4_playerChet"/>
<animate attributeName="x" begin="b4_anim39.end" dur="0.5s" fill="freeze" id="b4_anim40" repeatCount="1" to="50" xlink:href="#b4_playerChet"/>
<animate attributeName="y" begin="b4_anim39.end" dur="0.5s" fill="freeze" repeatCount="1" to="150" xlink:href="#b4_playerChet"/>
<text dominant-baseline="middle" font-family="Verdana" font-size="25" opacity="0" text-anchor="middle" x="50%" y="50%">
  <animate attributeName="opacity" begin="b4_anim40.end" dur="0.2s" fill="freeze" from="0" id="b4_anim41" repeatCount="1" to="1"/>
  <animate attributeName="opacity" begin="b4_anim41.end + 1s" dur="0.2s" fill="freeze" from="1" id="b4_anim42" repeatCount="1" to="0"/>
  Start of the turn
</text>


<text dominant-baseline="middle" font-family="Verdana" font-size="25" opacity="0" text-anchor="middle" x="50%" y="50%">
  <animate attributeName="opacity" begin="b4_anim42.end" dur="0.2s" fill="freeze" from="0" id="b4_anim43" repeatCount="1" to="1"/>
  <animate attributeName="opacity" begin="b4_anim43.end + 1s" dur="0.2s" fill="freeze" from="1" id="b4_anim44" repeatCount="1" to="0"/>
  Chet rolled a 3
</text>


<animate attributeName="x" begin="b4_anim44.end" dur="0.5s" fill="freeze" id="b4_anim45" repeatCount="1" to="0" xlink:href="#b4_playerChet"/>
<animate attributeName="y" begin="b4_anim44.end" dur="0.5s" fill="freeze" repeatCount="1" to="50" xlink:href="#b4_playerChet"/>
<animate attributeName="x" begin="b4_anim45.end" dur="0.5s" fill="freeze" id="b4_anim46" repeatCount="1" to="0" xlink:href="#b4_playerChet"/>
<animate attributeName="y" begin="b4_anim45.end" dur="0.5s" fill="freeze" repeatCount="1" to="0" xlink:href="#b4_playerChet"/>
<animate attributeName="x" begin="b4_anim46.end" dur="0.5s" fill="freeze" id="b4_anim47" repeatCount="1" to="50" xlink:href="#b4_playerChet"/>
<animate attributeName="y" begin="b4_anim46.end" dur="0.5s" fill="freeze" repeatCount="1" to="0" xlink:href="#b4_playerChet"/>
<text dominant-baseline="middle" font-family="Verdana" font-size="25" id="b4_text1" opacity="1" text-anchor="middle" x="50%" y="50%">
  ...
  <set attributeName="opacity" begin="b4_anim47.end + 1s" fill="freeze" repeatCount="1" to="1"/>
  Click to start
</text>
<rect height="200" opacity="0.1" width="800" x="0" y="0">
  ...
  <animate attributeName="x" begin="b4_anim47.end + 1s" dur="0.01s" fill="freeze" from="0" id="b4_animEnd" repeatCount="1" to="0"/>
  <set attributeName="width" begin="b4_anim47.end + 1s" fill="freeze" repeatCount="1" to="800"/>
  <set attributeName="height" begin="b4_anim47.end + 1s" fill="freeze" repeatCount="1" to="200"/>
</rect>
<style>
text {
font-size: 30px;
