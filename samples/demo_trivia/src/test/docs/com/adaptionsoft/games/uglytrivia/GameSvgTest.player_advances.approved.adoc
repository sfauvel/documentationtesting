...
<circle opacity="1" id="b1_playerA" cx="25" cy="25" r="15" fill="grey" stroke="black" stroke-width="1">
<set begin="b1_animEnd.end" attributeName="cx" to="25" repeatCount="1" fill="freeze"/>
<set begin="b1_animEnd.end" attributeName="cy" to="25" repeatCount="1" fill="freeze"/>
</circle>
...
<text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-family="Verdana" font-size="25" opacity="0">Chet rolled a 4<animate id="b1_anim3" begin="b1_anim2.end" attributeName="opacity" from="0" to="1" dur="0.2s" repeatCount="1" fill="freeze"/>
<animate id="b1_anim4" begin="b1_anim3.end + 1s" attributeName="opacity" from="1" to="0" dur="0.2s" repeatCount="1" fill="freeze"/>
</text>


<animate id="b1_anim5" xlink:href="#b1_playerA" begin="b1_anim4.end" attributeName="cx" to="75" dur="0.5s" repeatCount="1" fill="freeze"/>
<animate  xlink:href="#b1_playerA" begin="b1_anim4.end" attributeName="cy" to="25" dur="0.5s" repeatCount="1" fill="freeze"/>
<animate id="b1_anim6" xlink:href="#b1_playerA" begin="b1_anim5.end" attributeName="cx" to="125" dur="0.5s" repeatCount="1" fill="freeze"/>
<animate  xlink:href="#b1_playerA" begin="b1_anim5.end" attributeName="cy" to="25" dur="0.5s" repeatCount="1" fill="freeze"/>
<animate id="b1_anim7" xlink:href="#b1_playerA" begin="b1_anim6.end" attributeName="cx" to="175" dur="0.5s" repeatCount="1" fill="freeze"/>
<animate  xlink:href="#b1_playerA" begin="b1_anim6.end" attributeName="cy" to="25" dur="0.5s" repeatCount="1" fill="freeze"/>
<animate id="b1_anim8" xlink:href="#b1_playerA" begin="b1_anim7.end" attributeName="cx" to="175" dur="0.5s" repeatCount="1" fill="freeze"/>
<animate  xlink:href="#b1_playerA" begin="b1_anim7.end" attributeName="cy" to="75" dur="0.5s" repeatCount="1" fill="freeze"/>
<text id="b1_text1" x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-family="Verdana" font-size="25" opacity="1"><set begin="b1_anim0.begin" attributeName="opacity" to="0" repeatCount="1" fill="freeze"/><set begin="b1_anim8.end + 1s" attributeName="opacity" to="1" repeatCount="1" fill="freeze"/>Click to start</text>
<rect x="0" y="0" width="800" height="200" opacity="0.1">
  ...
  <animate id="b1_animEnd" begin="b1_anim8.end + 1s" attributeName="x" from="0" to="0" dur="0.01s" repeatCount="1" fill="freeze"/>
  <set begin="b1_anim8.end + 1s" attributeName="width" to="800" repeatCount="1" fill="freeze"/>
  <set begin="b1_anim8.end + 1s" attributeName="height" to="200" repeatCount="1" fill="freeze"/>
</rect>
<style>
text {
font-size: 30px;
...
<rect x="0" y="100" width="50" height="50" fill="#f4f407" stroke="black" stroke-width="1" />
<rect x="0" y="50" width="50" height="50" fill="#f23939" stroke="black" stroke-width="1" />
<circle opacity="1" id="b2_playerA" cx="25" cy="125" r="15" fill="grey" stroke="black" stroke-width="1">
<set begin="b2_animEnd.end" attributeName="cx" to="25" repeatCount="1" fill="freeze"/>
<set begin="b2_animEnd.end" attributeName="cy" to="125" repeatCount="1" fill="freeze"/>
</circle>
...
<text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-family="Verdana" font-size="25" opacity="0">Start of the turn<animate id="b2_anim9" begin="b2_anim8.end" attributeName="opacity" from="0" to="1" dur="0.2s" repeatCount="1" fill="freeze"/>
<animate id="b2_anim10" begin="b2_anim9.end + 1s" attributeName="opacity" from="1" to="0" dur="0.2s" repeatCount="1" fill="freeze"/>
</text>


<text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-family="Verdana" font-size="25" opacity="0">Chet rolled a 3<animate id="b2_anim11" begin="b2_anim10.end" attributeName="opacity" from="0" to="1" dur="0.2s" repeatCount="1" fill="freeze"/>
<animate id="b2_anim12" begin="b2_anim11.end + 1s" attributeName="opacity" from="1" to="0" dur="0.2s" repeatCount="1" fill="freeze"/>
</text>


<animate id="b2_anim13" xlink:href="#b2_playerA" begin="b2_anim12.end" attributeName="cx" to="25" dur="0.5s" repeatCount="1" fill="freeze"/>
<animate  xlink:href="#b2_playerA" begin="b2_anim12.end" attributeName="cy" to="75" dur="0.5s" repeatCount="1" fill="freeze"/>
<animate id="b2_anim14" xlink:href="#b2_playerA" begin="b2_anim13.end" attributeName="cx" to="25" dur="0.5s" repeatCount="1" fill="freeze"/>
<animate  xlink:href="#b2_playerA" begin="b2_anim13.end" attributeName="cy" to="25" dur="0.5s" repeatCount="1" fill="freeze"/>
<animate id="b2_anim15" xlink:href="#b2_playerA" begin="b2_anim14.end" attributeName="cx" to="75" dur="0.5s" repeatCount="1" fill="freeze"/>
<animate  xlink:href="#b2_playerA" begin="b2_anim14.end" attributeName="cy" to="25" dur="0.5s" repeatCount="1" fill="freeze"/>
<text id="b2_text1" x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-family="Verdana" font-size="25" opacity="1"><set begin="b2_anim8.begin" attributeName="opacity" to="0" repeatCount="1" fill="freeze"/><set begin="b2_anim15.end + 1s" attributeName="opacity" to="1" repeatCount="1" fill="freeze"/>Click to start</text>
<rect x="0" y="0" width="800" height="200" opacity="0.1">
  <animate id="b2_anim8" begin="click" attributeName="x" from="0" to="0" dur="0.01s" repeatCount="1" fill="freeze"/>
  <set begin="b2_anim8.begin" attributeName="width" to="50" repeatCount="1" fill="freeze"/>
  <set begin="b2_anim8.begin" attributeName="height" to="50" repeatCount="1" fill="freeze"/>
  <animate id="b2_animEnd" begin="b2_anim15.end + 1s" attributeName="x" from="0" to="0" dur="0.01s" repeatCount="1" fill="freeze"/>
  <set begin="b2_anim15.end + 1s" attributeName="width" to="800" repeatCount="1" fill="freeze"/>
  <set begin="b2_anim15.end + 1s" attributeName="height" to="200" repeatCount="1" fill="freeze"/>
</rect>
<style>
text {
font-size: 30px;
