...
<text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-family="Verdana" font-size="25" opacity="0">Start of the turn<animate dur="0.2s" attributeName="opacity" from="0" id="b3_anim25" to="1" fill="freeze" begin="b3_anim24.end" repeatCount="1"/>
<animate dur="0.2s" attributeName="opacity" from="1" id="b3_anim26" to="0" fill="freeze" begin="b3_anim25.end + 1s" repeatCount="1"/>
</text>


<text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-family="Verdana" font-size="25" opacity="0">Chet rolled a 4<animate dur="0.2s" attributeName="opacity" from="0" id="b3_anim27" to="1" fill="freeze" begin="b3_anim26.end" repeatCount="1"/>
<animate dur="0.2s" attributeName="opacity" from="1" id="b3_anim28" to="0" fill="freeze" begin="b3_anim27.end + 1s" repeatCount="1"/>
</text>


<animate dur="0.5s" attributeName="x" id="b3_anim29" to="50" fill="freeze" begin="b3_anim28.end" xlink:href="#b3_playerA" repeatCount="1"/>
<animate dur="0.5s" attributeName="y" to="0" fill="freeze" begin="b3_anim28.end" xlink:href="#b3_playerA" repeatCount="1"/>
<animate dur="0.5s" attributeName="x" id="b3_anim30" to="100" fill="freeze" begin="b3_anim29.end" xlink:href="#b3_playerA" repeatCount="1"/>
<animate dur="0.5s" attributeName="y" to="0" fill="freeze" begin="b3_anim29.end" xlink:href="#b3_playerA" repeatCount="1"/>
<animate dur="0.5s" attributeName="x" id="b3_anim31" to="150" fill="freeze" begin="b3_anim30.end" xlink:href="#b3_playerA" repeatCount="1"/>
<animate dur="0.5s" attributeName="y" to="0" fill="freeze" begin="b3_anim30.end" xlink:href="#b3_playerA" repeatCount="1"/>
<animate dur="0.5s" attributeName="x" id="b3_anim32" to="150" fill="freeze" begin="b3_anim31.end" xlink:href="#b3_playerA" repeatCount="1"/>
<animate dur="0.5s" attributeName="y" to="50" fill="freeze" begin="b3_anim31.end" xlink:href="#b3_playerA" repeatCount="1"/>
...
<rect x="0" width="800" y="0" opacity="0.1" height="200">
  <animate dur="0.01s" attributeName="x" from="0" id="b3_anim24" to="0" fill="freeze" begin="click" repeatCount="1"/>
  <set attributeName="width" to="50" fill="freeze" begin="b3_anim24.begin" repeatCount="1"/>
  <set attributeName="height" to="50" fill="freeze" begin="b3_anim24.begin" repeatCount="1"/>
  <animate dur="0.01s" attributeName="x" from="0" id="b3_animEnd" to="0" fill="freeze" begin="b3_anim32.end + 1s" repeatCount="1"/>
  <set attributeName="width" to="800" fill="freeze" begin="b3_anim32.end + 1s" repeatCount="1"/>
  <set attributeName="height" to="200" fill="freeze" begin="b3_anim32.end + 1s" repeatCount="1"/>
</rect>
<style>
text {
font-size: 30px;
