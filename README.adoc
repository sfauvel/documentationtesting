...
----
include::demo_basic/src/test/java/org/sfvl/application/demo/DemoTest.java[]
----

|===
| File generated
a| include::demo_basic/src/test/docs/org/sfvl/application/demo/DemoTest.should_be_5_when_adding_2_and_3.approved.adoc[]
|===
