...
include::_ParsedClassRepositoryTest.RetrieveLineNumber.retrieve_line_of_a_field.approved.adoc[leveloffset=+2]

include::_ParsedClassRepositoryTest.RetrieveLineNumber.retrieve_line_of_a_subclass_field.approved.adoc[leveloffset=+2]
