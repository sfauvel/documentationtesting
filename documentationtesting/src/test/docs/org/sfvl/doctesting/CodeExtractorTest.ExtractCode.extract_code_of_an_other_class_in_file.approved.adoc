[#org_sfvl_doctesting_CodeExtractorTest_ExtractCode_extract_code_of_an_other_class_in_file]
...
++++
<style>
#org_sfvl_doctesting_CodeExtractorTest_ExtractCode_extract_code_of_an_other_class_in_file ~ .inline {
