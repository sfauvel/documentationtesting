[#org_sfvl_doctesting_CodeExtractorTest_ExtractComment_extract_method_comment]
...
++++
<style>
#org_sfvl_doctesting_CodeExtractorTest_ExtractComment_extract_method_comment ~ .inline {
