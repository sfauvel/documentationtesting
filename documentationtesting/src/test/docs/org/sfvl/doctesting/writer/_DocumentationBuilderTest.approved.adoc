...
[#org_sfvl_doctesting_writer_DocumentationBuilderTest]
...
[#org_sfvl_doctesting_writer_DocumentationBuilderTest_RelativizedToPath]
== Relativized to path
...
[#org_sfvl_doctesting_writer_DocumentationBuilderTest_check_class_for_structure]
