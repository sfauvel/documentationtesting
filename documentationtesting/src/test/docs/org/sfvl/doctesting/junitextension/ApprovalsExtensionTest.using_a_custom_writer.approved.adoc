...
When executing test method `test_A`, a file `MyCustomWriterTest.test_A.approved.adoc` is generated and contains the following text
----
include::../../samples/MyCustomWriterTest.test_A.approved.adoc[]
----