[#org_sfvl_doctesting_CodeExtractorTest_ExtractComment_extract_class_comment]
...
[source, java, indent=0]
----
include::../../../../java/org/sfvl/doctesting/CodeExtractorTest.java[tag=NestedClass]
----
...
++++
<style>
#org_sfvl_doctesting_CodeExtractorTest_ExtractComment_extract_class_comment ~ .inline {
