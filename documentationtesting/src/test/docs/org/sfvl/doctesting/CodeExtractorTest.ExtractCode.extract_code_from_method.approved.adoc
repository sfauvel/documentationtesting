[#org_sfvl_doctesting_CodeExtractorTest_ExtractCode_extract_code_from_method]
...
++++
<style>
#org_sfvl_doctesting_CodeExtractorTest_ExtractCode_extract_code_from_method ~ .inline {
