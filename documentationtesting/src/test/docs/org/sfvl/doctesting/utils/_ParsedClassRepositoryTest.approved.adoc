...
[#org_sfvl_doctesting_utils_parsedclassrepositorytest]
...
[#org_sfvl_doctesting_utils_parsedclassrepositorytest_retrievecomment]
== Retrieve comment
...
[#org_sfvl_doctesting_utils_parsedclassrepositorytest_retrievelinenumber]
