...
[#org_sfvl_doctesting_utils_codeextractortest_extractcodeandresult]
...
[#org_sfvl_doctesting_utils_codeextractortest_groupbyresult]
== Group by result

include::_CodeExtractorTest.GroupByResult.description.approved.adoc[leveloffset=+2]

include::_CodeExtractorTest.GroupByResult.applying_a_function.approved.adoc[leveloffset=+2]

include::_CodeExtractorTest.GroupByResult.code_used_to_provide_a_result.approved.adoc[leveloffset=+2]