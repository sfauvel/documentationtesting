[#org_sfvl_doctesting_CodeExtractorTest_ExtractCode_ExtractPartOfCode_tag_with_same_beginning_of_another_tag]
...
++++
<style>
#org_sfvl_doctesting_CodeExtractorTest_ExtractCode_ExtractPartOfCode_tag_with_same_beginning_of_another_tag ~ .inline {
