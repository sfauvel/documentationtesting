[#org_sfvl_doctesting_CodeExtractorTest_ExtractCode_ExtractPartOfCode_tag_beginning_with_same_outer_tag_name]
...
++++
<style>
#org_sfvl_doctesting_CodeExtractorTest_ExtractCode_ExtractPartOfCode_tag_beginning_with_same_outer_tag_name ~ .inline {
